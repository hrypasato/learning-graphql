...
const pgApiWrapper = async () => {
    ...
    return {
        ...
        taskInfo: async ({ taskIds, currentUser }) => {
            const pgResp = await pgQuery(sqls.tasksFromIds, { $1: taskIds, $2: currentUser ? currentUser.id : null })
